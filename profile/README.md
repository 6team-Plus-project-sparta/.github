...
| **User**      | **임하은** | 회원가입/로그인, JWT 인증/인가, 내 정보 관리, 내 예매 내역/상세 조회, 회원 등급 관리      |
...
* [데이터베이스 설계](https://github.com/6team-Plus-project-sparta/docs/blob/main/v2/5.%20erd.md) — ERD 및 핵심 테이블 구조
